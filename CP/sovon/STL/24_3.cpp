//auto and ranged based loop ka ashol panda ....
#include<bits/stdc++.h>
using namespace std;
int main(){
 ...
 //  vector<int> :: iterator it = v.begin();
   //i am modifying this line ,also i can comment out the previous line , this is because of the auto keyword
...
//by the use of auto i am decommenting following line
